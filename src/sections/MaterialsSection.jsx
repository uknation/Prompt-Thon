...
export default function MaterialsSection({ materialAnalysis }) {
  return (
    ...
    >
      {!materialAnalysis ? (
        <EmptyStageState
          title="Material Engine Waiting"
          description="Once structural geometry is available, the material engine will rank practical systems for the shell, partitions, and floor package."
          hint="Stage 2 and Stage 3 provide the structural signal"
        />
      ) : (
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <div className="space-y-4">
            <MetricCard label="Total cost" value={formatCurrencyLakh(materialAnalysis.summary.totalCostLakh)} accent="text-coral" hint="Structural package estimate" />
            <MetricCard label="Embodied carbon" value={`${materialAnalysis.summary.embodiedCarbon} tCO2e`} accent="text-aqua" />
